...
print('redirect_url', getattr(response, 'url', None))
print('deposit_count', Deposit.objects.count())
print('client_exists', User.objects.filter(account_code=client_user.account_code).exists())
print('client_code', client_user.account_code)
